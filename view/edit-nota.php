...
<form action="edit-nota.php?id=<?php echo $nota['id_notas']; ?>" method="post">
  ...
  <div class="row">
    <div class="form-group col-md-2">
      ...
      <input type="text" id="nome" class="form-control" name="nota1" value="<?php echo $nota['nota1']; ?>">
    </div>

    <div class="form-group col-md-2">
      <label for="name">nota 2</label>
      <input type="text" id="notas" class="form-control" name="nota2" value="<?php echo $nota['nota2']; ?>">
    </div>

    <div class="form-group col-md-2">
      <label for="name">nota 3</label>
      <input type="text" id="curso" class="form-control" name="nota3" value="<?php echo $nota['nota3']; ?>">
    </div>

    <div class="form-group col-md-2">
      <label for="name">nota 4</label>
      <input type="text" id="curso" class="form-control" name="nota4" value="<?php echo $nota['nota4']; ?>">
    </div>
