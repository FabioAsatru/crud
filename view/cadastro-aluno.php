...
<form action="cadastro-aluno.php" method="post">
  ...
  <div class="row">
    <div class="form-group col-md-5">
      ...
      <input type="text" id="rua" class="form-control" name="logradouro" required>
    </div>
    ...
    <div class="form-group col-md-2">
      ...
      <input type="text" class="form-control" name="data_criacao" disabled>
    </div>
  </div>
  ...
  <div class="row">
    ...
    <div class="row">
      <div class="form-group col-md-3">
        ...
        <input type="text" id="cidade" class="form-control" name="numero" required>
      </div>
